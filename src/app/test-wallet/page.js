...
export default function TestWalletPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Wallet Creation Test</h1>
        ...
        <Card>
          ...
          <CardContent>
            <ol className="list-decimal list-inside space-y-2">
              <li>Click "Test Wallet Creation" to test if wallet creation works</li>
              <li>If successful, you should see wallet details in the result</li>
              <li>Click "Test Withdraw API" to test the full withdrawal process</li>
