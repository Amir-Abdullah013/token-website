  ...
  const fetchDashboardData = async () => {
    try {
      ...
      try {
        ...
        console.warn(
          "⚠️ Could not fetch recent activity, using fallback:",
          activityError
        );
        ...
        const recentActivity = [
          ...
          {
            type: "deposit",
            message: "Large deposit processed",
            time: "15m ago",
            status: "info",
          },
          {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-300 mt-2">
              Welcome back, {adminUser?.name || "Admin"}! Manage your
              application.
            </p>
          </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {dashboardData.recentActivity.map((activity, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-2 bg-gradient-to-r from-slate-700/30 to-slate-800/30 rounded-lg border border-slate-600/30 hover:scale-105 transition-all duration-300"
                      >
                        <div className="flex items-center">
                          <div
