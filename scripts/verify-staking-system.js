...
const verifyStakingSystem = async () => {
  try {
    ...
    if (userWallet.rows.length > 0) {
      ...
      console.log(`   TIKI Balance: ${wallet.tikiBalance} TIKI`);
    ...
    if (transactions.rows.length > 0) {
      ...
      console.log(`   Amount: ${transaction.amount} TIKI`);
    ...
    console.log('========================');
    console.log(`✅ Staking Amount: ${staking.amountStaked} TIKI`);
    console.log(`✅ Reward Amount: ${rewardAmount} TIKI (${staking.rewardPercent}%)`);
    console.log(`✅ Total Received: ${totalAmount} TIKI`);
    console.log(`✅ Status: ${staking.status} (CLAIMED)`);
    console.log(`✅ Claimed: ${staking.claimed} (true)`);
    console.log(`✅ Profit Recorded: ${staking.profit} TIKI`);
